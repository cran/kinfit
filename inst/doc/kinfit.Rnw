% $Id: kinfit.Rnw 59 2010-07-28 12:29:15Z jranke $
...
calculated by KinGUI based on the same formula (FOCUS 2006, p. 99). This
exercise was done for FOCUS datasets A to D only.
